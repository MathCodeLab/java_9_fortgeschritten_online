...
public class Wiederholung_classVariablen_und_methoden2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Wiederholung_classVariablen_und_methoden2.y); // 3
        System.out.println(Mensch.alter); // 5

        Mensch.alter = 8;
        System.out.println(Mensch.alter); // 8
        System.out.println(alter); // 100
        System.out.println(Wiederholung_classVariablen_und_methoden2.alter); // 500
        System.out.println(Hund.name);
        System.out.println(Mensch.name);

        System.out.println(Mensch.alter);
        System.out.println(Wiederholung_classVariablen_und_methoden2.alter);

        System.out.println(Wiederholung_classVariablen_und_methoden2.y);
