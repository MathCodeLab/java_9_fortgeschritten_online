...
public class Klassen_Postion_der_Variables_und_Methoden_und_static_8 {
    int anzahlFensters;
    String farbe;
    ...
    public static void main(String[] args) {
        ...
        ort = "Berlin";
        System.out.println(Klassen_Postion_der_Variables_und_Methoden_und_static_8.ort);

        // 2. Objekt erstellen
        Klassen_Postion_der_Variables_und_Methoden_und_static_8 kleinHaus = new Klassen_Postion_der_Variables_und_Methoden_und_static_8();
