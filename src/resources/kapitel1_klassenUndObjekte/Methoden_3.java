...
- Beispiel: angenommen, man muss ein Programm erstellen, um einen Kreis zu zeichnen und zu färben.
  ...
  -> Die Aufteilung einer komplexen Fragestellung in kleinere Teile macht das Programm leicht verständlich und wiederverwendbar.
...
1. Deklaration einer Methode:
    ...
    - Da wir in diesem Kurs noch nicht gelernt haben, wie man mit Klassen umgeht, werden wir uns in diesem Tutorial darauf beschränken,
      Methoden innerhalb derselben Klasse (in der sich die main-Methode befindet) zu deklarieren.
...
- modifier: - Definiert den Zugriffstyp (falls der modifier ein Zugriffmodifier waere!), ob die Methode "public", "private" usw. ist.
